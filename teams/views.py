...
from teams.auth_helper import get_sign_in_flow, get_token_from_code, store_user, remove_user_and_token, get_token
from teams.teams_helper import *
...
def newevent(request):
  ...
  if request.method == 'POST':
    ...
    if (not request.POST['ev-subject']) or \
      ...
      return render(request, 'teams/newevent.html', context)
...
def videotext(request):
  ...
  return render(request, 'teams/videoandtext.html', context)